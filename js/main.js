const galleryImages = [
  "img_4822.jpg","img_4823.jpg","img_4824.jpg","img_4825.jpg","img_4826.jpg","img_4827.jpg",
  "img_4828.jpg","img_4829.jpg","img_4830.jpg","img_4832.jpg","img_4833.jpg","img_4834.jpg",
  "img_4835.jpg","img_4836.jpg","img_4837.jpg","img_4838.jpg","img_4839.jpg","img_4840.jpg",
  "img_4841.jpg","img_4842.jpg","img_4843.jpg","img_4844.jpg"
];
...
const translations = {
  ko:{
    ...
    "shop.coupang":"쿠팡에서 만나기 ↗","shop.naver":"네이버 스마트스토어 ↗","shop.placeholder":"링크 준비 중",
  ...
  zh:{
    ...
    "shop.title":"把 Ttolttoli 小番茄<br><em>带回家。</em>","shop.copy":"这里预留购买链接。准备好真实地址后即可直接连接。","shop.coupang":"在 Coupang 认识我们 ↗","shop.naver":"Naver Smart Store ↗","shop.placeholder":"链接准备中",
  ...
  en:{
    ...
    "shop.title":"Bring Ttolttoli tomatoes<br><em>home.</em>","shop.copy":"A space reserved for purchase links. Add the real store addresses when they are ready.","shop.coupang":"Find us on Coupang ↗","shop.naver":"Naver Smart Store ↗","shop.placeholder":"Link coming soon",
  ...
  ja:{
    ...
    "shop.title":"トルトリのトマトを<br><em>ご家庭へ。</em>","shop.copy":"購入リンクをつなぐ場所です。実際のURLが決まったらボタンに設定できます。","shop.coupang":"Coupangで見る ↗","shop.naver":"Naver Smart Store ↗","shop.placeholder":"リンク準備中",
...
function buildGallery(){
  ...
  galleryImages.forEach((name, index) => {
    ...
    cap.textContent = `FARM RECORD ${String(index + 1).padStart(2,"0")}`;
    fig.append(img, cap);
